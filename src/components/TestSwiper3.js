...
class TestSwiper3 extends React.Component {
  render() {
    const params = {
    ...
    return (
      <div className={styles.container}>
        <Swiper {...params}>
          ...
          <div style={divStyle}><img width="200px" height="200px" src="https://dsh602wr9lxr7.cloudfront.net/suzy2.jpg"/></div>
          <div style={divStyle}><img width="180px" height="200px" src="https://dsh602wr9lxr7.cloudfront.net/suzy.jpg"/></div>
        </Swiper>
      </div>
    );
  }
